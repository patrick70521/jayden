      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Card className="bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm border-green-500/30">
          <CardContent className="p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Victory Analysis</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-green-500/20 rounded-lg p-4 border border-green-500/30">
                ...
                <div className="text-green-200">Goals Scored</div>
              </div>
              <div className="bg-blue-500/20 rounded-lg p-4 border border-blue-500/30">
                <div className="text-2xl font-bold text-blue-300">53%</div>
                <div className="text-blue-200">Shot Accuracy</div>
              </div>
              <div className="bg-purple-500/20 rounded-lg p-4 border border-purple-500/30">
                <div className="text-2xl font-bold text-purple-300">90+4'</div>
                <div className="text-purple-200">Winning Goal Time</div>
              </div>
            </div>
